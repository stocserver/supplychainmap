  ...
  products: [
    ...
    },
    {
      ...
      companiesDetailed: [
        ...
        { name: 'Teradata', ticker: 'TDC', listing: 'US' },
        { name: 'Couchbase', ticker: 'BASE', listing: 'US' },
    ...
    },
    {
      ...
      companiesDetailed: [
        ...
        { name: 'Limelight Networks', ticker: 'LLNW', listing: 'US' },
      ],
  ...
  products: [
    {
      ...
      companiesDetailed: [
        ...
        { name: 'Zoom Video', ticker: 'ZM', listing: 'US' },
        ...
        { name: 'Zuora', ticker: 'ZUO', listing: 'US' },
      ],
